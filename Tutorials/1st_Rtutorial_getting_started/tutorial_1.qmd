...
-   Uploading a file to Rstudio/ Copying and pasting plain text.
...
[^1]: Sometimes students get frustrated and complete the projects in a document with outputs from the console, that's ok you just lose a point.

# Chunk vs white space

-   Spacing in chunk

-   Chunk titles

-   Extra: R markdown cheat sheet.

# Assignment make first knit .Rmd file.

-   Delete all the default stuff.

-   Add a chunk to add some numbers together.

-   Write a sentence about what you hope to learn or accomplish in this class.

-   Save it as your_name_tut_1.

-   Knit your markdown file and post it to the 1st R tutorial forum.
